...
// NOTES FROM JORDAN :
// the task below cannot use an arrow function
// because arrow functions derive this from an external context
// meaning in this case that 'this' would refer to the window
...
let user = {
  ...
  // this function would not work as expected
  getUsernameArrow: () => {
    console.log("THIS", this);
    console.log("THIS IS WINDOW", this === window);
    // the below statement will returned undefined
    return this.username;
  }
};
////////// PROBLEM 2 //////////
...
//Code Here
let animal1 = new Animal("Sophi", "mutt", "Grains");
////////// PROBLEM 3 //////////
